...
namespace Tests
{
    public class printBlochVectorTests
    {
        ...
        public void thetaZero_Tests()
        {
            ...
            Assert.AreEqual("|Ψ> = 1 |0> + 0 |1>", quantumBit.print_bloch_vector());
        ...
        public void theta_30_phi_0_Tests(){
            ...
            quantumBit.phiAngle = 0;
            Assert.AreEqual("|Ψ> = 0,966 |0> + 0,259 |1>", quantumBit.print_bloch_vector());
        }

        [Test]
        public void theta_30_phi_45_Tests(){
            quantumBit = new Qubit(30,45);
            Assert.AreEqual("|Ψ> = 0,966 |0> + 0,183 + 0,183i |1>", quantumBit.print_bloch_vector());
        }
        ...
        public void theta_30_phi_90_Tests(){
            ...
            quantumBit.thetaAngle = 30;
            quantumBit.phiAngle = 90;
            Assert.AreEqual("|Ψ> = 0,966 |0> + 0,259i |1>", quantumBit.print_bloch_vector());
        }
        ...
        public void theta_30_phi_359_Tests(){
            ...
            Assert.AreEqual("|Ψ> = 0,966 |0> + 0,259 - 0,005i |1>", quantumBit.print_bloch_vector());
        }
        ...
        public void theta_45_phi_0_Test(){
            ...
            quantumBit.phiAngle = 0;
            Assert.AreEqual("|Ψ> = 0,924 |0> + 0,383 |1>", quantumBit.print_bloch_vector());
        }

        [Test]
        public void theta_45_phi_45_Test(){
            quantumBit = new Qubit(45,45);
            Assert.AreEqual("|Ψ> = 0,924 |0> + 0,271 + 0,271i |1>", quantumBit.print_bloch_vector());
        }
        ...
        public void theta_45_phi_90_Test(){
            ...
            quantumBit.thetaAngle = 45;
            quantumBit.phiAngle = 90;
            Assert.AreEqual("|Ψ> = 0,924 |0> + 0,383i |1>", quantumBit.print_bloch_vector());
        }
        ...
        public void theta_45_phi_359_Test(){
            ...
            Assert.AreEqual("|Ψ> = 0,924 |0> + 0,383 - 0,007i |1>", quantumBit.print_bloch_vector());
        }
        ...
        public void theta_60_phi_0_with_settings_Tests(){
            ...
            Assert.AreEqual("|Ψ> = 0,866 |0> + 0,5 |1>", quantumBit.print_bloch_vector());
        }
        ...
        public void theta_60_phi_45_Tests(){
            quantumBit = new Qubit(60,0);
            quantumBit.phiAngle = 45;
            Assert.AreEqual("|Ψ> = 0,866 |0> + 0,354 + 0,354i |1>", quantumBit.print_bloch_vector());
        }
        ...
        public void theta_60_phi_90_with_settings_Tests(){
            ...
            PrintBlochSettings settings = new PrintBlochSettings(true,true,3,DecimalSeparator.comma,ImaginaryUnit.i);
            Assert.AreEqual("|Ψ> = 0,866 |0> + 0,500i |1>", quantumBit.print_bloch_vector(settings));
        }
        ...
        public void theta_120_phi_0_Tests(){
            ...
            quantumBit.phiAngle = 0;
            Assert.AreEqual("|Ψ> = 0,5 |0> + 0,866 |1>", quantumBit.print_bloch_vector());
        }
        ...
        public void theta120_phi_45_Test(){
            ...
            quantumBit.thetaAngle = 120;
            quantumBit.phiAngle = 45;
            Assert.AreEqual("|Ψ> = 0,5 |0> + 0,612 + 0,612i |1>", quantumBit.print_bloch_vector());
        }
        ...
        public void theta_120_phi_90_Test(){
            ...
            quantumBit.thetaAngle = 120;
            quantumBit.phiAngle = 90;
            Assert.AreEqual("|Ψ> = 0,5 |0> + 0,866i |1>", quantumBit.print_bloch_vector());
        }
        ...
        public void theta_120_phi_359_Test(){
            ...
            quantumBit.thetaAngle = 120;
            quantumBit.phiAngle = 359;
            Assert.AreEqual("|Ψ> = 0,5 |0> + 0,866 - 0,015i |1>", quantumBit.print_bloch_vector());
        }
        ...
        public void theta_180_phi_0_Tests(){
            ...
            quantumBit.phiAngle = 0;
            Assert.AreEqual("|Ψ> = 0 |0> + 1 |1>", quantumBit.print_bloch_vector());
        }

        [Test]
        public void theta_180_phi_45_Tests(){
            quantumBit = new Qubit(180,45);
            Assert.AreEqual("|Ψ> = 0 |0> + 0,707 + 0,707i |1>", quantumBit.print_bloch_vector());
        }
        ...
        public void theta_180_phi_90_Tests(){
            ...
            quantumBit.thetaAngle = 180;
            quantumBit.phiAngle = 90;
            Assert.AreEqual("|Ψ> = 0 |0> + i |1>", quantumBit.print_bloch_vector());
        }
        ...
        public void theta_180_phi_359_Tests(){
            ...
            quantumBit.thetaAngle = 180;
            quantumBit.phiAngle = 359;
            Assert.AreEqual("|Ψ> = 0 |0> + 1 - 0,017i |1>", quantumBit.print_bloch_vector());
        }
